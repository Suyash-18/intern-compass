          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter the task information and requirements
                </CardDescription>
              </CardHeader>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select interns to receive this task
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2 p-3 bg-muted rounded-lg">
                  <Checkbox 
                    id="assignAll" 
                    checked={assignToAll}
                    onCheckedChange={(checked) => handleAssignToAllChange(checked as boolean)}
                  />
                  <Label 
                    htmlFor="assignAll" 
                    className="text-sm font-medium cursor-pointer flex-1"
                  >
                    Assign to all interns ({interns.length})
                  </Label>
                </div>
                ...
                {errors.assignment && (
                  <p className="text-sm text-destructive">{errors.assignment}</p>
                )}
                ...
                <div className="pt-2 border-t">
                  <p className="text-sm text-muted-foreground">
                    ...
                    {assignToAll 
                      ? `All ${interns.length} interns selected`
