    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-foreground text-background items-center justify-center p-12">
        <div className="max-w-md">
          ...
          <p className="text-xl text-background/70 mb-8">Streamline your internship program with structured task management and progress tracking.</p>
          <div className="space-y-4">
            {['Sequential task progression', 'Admin review & approval workflow', 'Progress tracking & reporting'].map((text, i) => (
              <div key={i} className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center"><span className="text-primary font-bold">{i + 1}</span></div>
      ...
      <div className="flex-1 flex items-center justify-center bg-background px-4 py-12">
        <div className="w-full max-w-md animate-fade-in">
          <div className="text-center mb-8 lg:hidden">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-foreground text-background mb-4"><Briefcase className="h-8 w-8" /></div>
          ...
          <Card className="border-0 shadow-2xl">
            ...
            <CardContent>
              ...
              <div className="mt-6 pt-6 border-t">
                ...
                <Button variant="outline" className="w-full h-12 text-base border-2" onClick={() => navigate('/register')}>
